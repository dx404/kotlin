...
public class BoxJsTestGenerated extends AbstractBoxJsTest {
    ...
    public class K2DifferencesChecks {
        ...
        public void testAllFilesPresentInK2DifferencesChecks() throws Exception {
            KtTestUtil.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("js/js.translator/testData/box/k2DifferencesChecks"), Pattern.compile("^([^_](.+))\\.kt$"), null, TargetBackend.JS, true);
        }
