...
public actual abstract class AbstractMutableMap<K, V> protected actual constructor() : AbstractMap<K, V>(), MutableMap<K, V> {
    ...
    protected open fun createKeysView(): MutableSet<K> = HashMapKeysDefault(this)
    protected open fun createValuesView(): MutableCollection<V> = HashMapValuesDefault(this)
