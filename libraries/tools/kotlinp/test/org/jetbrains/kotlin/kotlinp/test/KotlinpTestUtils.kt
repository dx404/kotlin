...
fun compareAllFiles(
    ...
    val isMutedForK2 = useK2 && InTextDirectivesUtils.findStringWithPrefixes(file.readText(), "// IGNORE K2") != null
    try {
    ...
    if (isMutedForK2) {
        throw AssertionError("Looks like this test can be unmuted. Remove the \"// IGNORE K2\" directive.")
    }
}
