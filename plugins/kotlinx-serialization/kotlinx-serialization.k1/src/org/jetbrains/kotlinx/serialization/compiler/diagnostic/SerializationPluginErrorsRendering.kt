...
object SerializationPluginErrorsRendering : DefaultErrorMessages.Extension {
    ...
    init {
        ...
        MAP.put(
            ...
            "Custom serializer ''{1}'' on serializable type ''{0}'' can not be instantiated. It is not allowed to specify the interface, abstract or sealed class as custom serializer.",
            Renderers.RENDER_TYPE,
            Renderers.RENDER_TYPE
        )
        MAP.put(
